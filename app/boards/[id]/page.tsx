...
function DroppableColumn({
    ...
    return (
    <div className={`w-full lg:shrink-0 lg:w-80 ${isOver ? "bg-blue-50 rounded-lg" : ""}`} ref={setNodeRef}>
...
export default function BoardPage() {
    ...
    const { board , updateBoard, columns, createRealTask, setColumns, moveTask, createColumn, updateColumn } = useBoard(id);
    ...
    async function createTask(taskData: {title: string, 
            description?: string, 
            assignee?: string, 
            dueDate?: string,
    ...
    async function handleDragEnd(event: DragEndEvent) {   
        ...
        if (targetColumn) {
            ...
            // check to see if we're on another task. 
            const sourceColumn = columns.find((col) => col.tasks.some((task) => task.id === taskId));
            const targetColumn = columns.find((col) => col.tasks.some((task) => task.id === overId));
    ...
    <>
        <div className="min-h-screen bg-gray-50">
            <Navbar boardTitle={board?.title}
                    ...
                    />
            <Dialog open={isEditingTitle === true} onOpenChange={setIsEditingTitle}>
                <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
                    <DialogHeader>
                        <DialogTitle>
                            Edit board. 
            ...
            <Dialog open={isFilterOpen} onOpenChange={setIsFilterOpen}>
                <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
                    ...
                    {/* Add the filter by assignee as an extension excercise.  */}
            ...
            <main className="container mx-auto px-2 sm:px-4 py-4 sm:py-6">
                {/* Board stats */}
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 space-x-4 sm:space-y-0">
                ...
                lg:pb-6 lg:px-2 lg:mx-2 lg:[&::-webkit-scrollbar]:h-2 lg:[&::-webkit-scrollbar-track]:bg-gray-100 
                lg:[&::-webkit-scrollbar-thumb]:bg-gray-300 lg:[&::-webkit-scrollbar-thumb]:rounded-full space-y-4 lg:space-y-0 ">
                    ...
                    {filteredColumns.map((column, key) => (
                        ...
                        >
                            ...
                            >
                                <div className="space-y-3">{column.tasks.map((task, key) => (
                    ...
                    <div className="w-full shrink-0 lg:w-80">
                        <Button variant="outline" className="w-full h-full min-h-[200px] border-dashed border-2 text-gray-500 hover:text-gray-700"
        ...
        <Dialog open={isCreatingColumn} onOpenChange={setIsCreatingColumn}>
            <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
                <DialogHeader>
                    ...
                    <p className="text-sm text-gray-600">Add new column to organise your tasks</p>
                </DialogHeader>
                <form className="space-y-4" onSubmit={handleCreateColumn}>
                    <div className="space-y-2"> 
                        ...
                        <Input  id="columnTitle" 
                                value={newColumnTitle} 
                                onChange={(e) => setNewColumnTitle(e.target.value as string)}
                ...
                <form className="space-y-4" onSubmit={handleUpdateColumn}>
                    <div className="space-y-2"> 
                        ...
                        <Input  id="columnTitle" 
                                ...
                                onChange={(e) => setEditingColumnTitle(e.target.value as string)}
                                placeholder="Enter column title"
                                required
                                />
                    </div>
