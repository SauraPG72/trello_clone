...
import { Filter, Ghost, Grid3x3, List, Loader2, Plus, Rocket, Search, Trello } from "lucide-react";
...
export default function DashboardPage() { 
    ...
    // add the boards with task count feature as an extension excercise. 
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <main className="container mx-auto px-4 py-6 sm:py-8">
            <div className="mb-6 sm:mb-8">
                ...
                <p className="text-gray-600">Here's whats happening with your boards today.</p>
            </div>
            ...
            <div className="mb-6 sm:mb-8">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 space-y-4 sm:space-y-0">
                    <div>
                        <h2 className="text-xl sm:text-2xl font text-gray-900">
                            Your boards
                        </h2>
                        <p className="text-gray-600">
                            Manage your projects and tasks
                        </p>
                        {isFreeUser && (<p className="text-sm text-gray-500 mt-1">
                            Free Plan: {boards.length}/1 boards used
                        </p>)}
                    </div>

                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 rounded">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <div>
                                ...
                                <Input  type="number" 
                                        ...
                                        onChange={(e) => 
                                                    setFilters((prev) => ({...prev, taskCount: {
                                                        ...prev.taskCount, 
        ...
        <Dialog open={showUpgradeDialog} onOpenChange={setShowUpgradeDialog}>
            <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
                <DialogHeader>
                    ...
                    <p className="text-sm text-gray-600">Free users can create only one board. 
